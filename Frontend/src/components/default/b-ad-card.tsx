...
import { Phone, MapPin, Store, User, Percent } from "lucide-react"
  ...
  return (
    <Card className="overflow-hidden h-full flex flex-col hover:shadow-md transition-shadow duration-200">
      <div className="relative h-40 sm:h-48 bg-gray-100">
        ...
        <Badge className="absolute top-2 right-2 bg-green-600 hover:bg-green-700">{interestRate}% Interest</Badge>
      </div>
      ...
      <CardFooter className="flex justify-between border-t pt-3 pb-3">
        <div className="text-xs text-muted-foreground">Posted on {format(createdAt, "MMM dd, yyyy")}</div>
